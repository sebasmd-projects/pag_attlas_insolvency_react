...
it('sets caching headers', async ({ request }) => {
  for (const pathname of ['/es', '/es/equipo', '/en', '/en/team']) {
...
<url>
<loc>http://localhost:3000/es/equipo</loc>
<xhtml:link rel="alternate" hreflang="es" href="http://localhost:3000/es/equipo" />
<xhtml:link rel="alternate" hreflang="en" href="http://localhost:3000/en/team" />
</url>
</urlset>
`
  );
