...
const BASE_EXPENSES = [
  ...
  { labelKey: 'table.defaults.items.baseExpenses.item4', legalKey: 'table.defaults.items.baseExpenses.item4.legalSupport', id: 4, editable: true, dependent: true },
  ...
  { labelKey: 'table.defaults.items.baseExpenses.item10', legalKey: 'table.defaults.items.baseExpenses.item10.legalSupport', id: 10, editable: true, dependent: true },
  ...
  { labelKey: 'table.defaults.items.baseExpenses.item13', legalKey: 'table.defaults.items.baseExpenses.item13.legalSupport', id: 13, editable: true, dependent: true },
