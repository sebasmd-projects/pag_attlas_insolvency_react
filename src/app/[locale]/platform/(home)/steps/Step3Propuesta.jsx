...
export default function Step3Propuesta({ data, onNext, onBack, isSubmitting }) {
    ...
    const handleSubmit = (e) => {
        ...
        if (!htmlContent || htmlContent.trim() === '') {
            alert('La propuesta de pago no puede estar vacía.');
            return;
        }
        ...
        onNext({ payment_proposal: cleanHtml });
    };
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="mb-2">
                <label className="form-label mx-3">Propuesta de pago</label>
                ...
                <div
                    ...
                    dangerouslySetInnerHTML={{ __html: data.payment_proposal || '' }}
                />
            </div>
